...
Usage Instructions:
-----------------
This script deploys changes from one or more GitHub Pull Requests to a Salesforce org.

Basic Usage:
    python deploy_pr.py --org <target_org_alias> --prs <github_pr_url>

Multiple PRs:
    python deploy_pr.py --org <target_org_alias> --prs <github_pr_url_1> <github_pr_url_2> <github_pr_url_3>

Interactive Mode:
    python deploy_pr.py --org <target_org_alias>
    (Script will prompt for PR URL)

Examples:
    python deploy_pr.py --org dev --prs https://github.com/username/repo/pull/123
    python deploy_pr.py --org staging --prs https://github.com/username/repo/pull/123 https://github.com/username/repo/pull/124
